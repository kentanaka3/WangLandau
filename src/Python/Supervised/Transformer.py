...
class Transformer(nn.Module):
  def __init__(self, args):
    ...
    self.layers.append(nn.TransformerEncoderLayer(args.input_size, args.hidden_size))
    self.layers.append(nn.TransformerEncoder(self.layers[0], args.hidden_layers))
